...
// import { Cog6ToothIcon as Cog6ToothIconOutline } from 'react-native-heroicons/solid';

import { CONSTANT } from '../../themes';
import BackIcon from '../../assets/icons/BackIcon.svg';
// import PoolNavComponent from '../../components/navbar/PoolNavComponent';
          ...
          <View className="justify-center items-center">
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                // let actiiveIconClass = isActive ? 'blue' : 'red';
                    ...
                    {item.Icon === GearIconOutline ? (
                      <View className="flex-row justify-center items-center space-x-2">
                        <item.Icon
                          ...
                          // className={'blue' + activeTextClass}
                        />
                        <Text
...
export default ConditionPoolPage;
